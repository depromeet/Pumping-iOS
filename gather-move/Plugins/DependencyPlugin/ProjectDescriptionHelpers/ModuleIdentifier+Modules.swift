...
//}
//
//// MARK: NetworkModuleIdentifier
//
//public class NetworkModuleIdentifier: ModuleIdentifier {
//    public static let id: NetworkModuleIdentifier = .init(project: "Network", target: "")
//    
//    public static let Interface: NetworkModuleIdentifier = .init(project: id.project, target: "NetworkInterface")
//}
//
